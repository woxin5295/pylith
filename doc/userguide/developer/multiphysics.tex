...
\underline{\Delta \epsilon}^{dev\;C}\approx\frac{\Delta
  t\dot{\epsilon}_{0}^{dev}\sqrt{^{\tau}J_{2}^{dev}}^{n-1}\,^{\tau}\underline{\sigma}^{dev}}{\left(\sigma_{0}^{dev}\right)^{n}}=\frac{\Delta
  t\dot{\epsilon}_{0}^{dev}\left(\phantom{}^{\tau}\overline{\sigma}^{dev}\right)^{n-1}\,^{\tau}\underline{\sigma}^{dev}}{\sqrt{3}\left(\sigma_{0}^{dev}\right)^{n}}\,
\end{equation}
Therefore,
\begin{equation}
...
\begin{equation}
  ...
  ^{t+\Delta t}\underline{\sigma}^{dev}=\frac{1}{a_{E}}\left\{
    ^{t+\Delta t}\underline{\epsilon}^{\prime\;dev}-\Delta
    t\phantom{}^{\tau}\gamma\left[\left(1-\alpha\right)^{t}\underline{\sigma}^{dev}+\alpha{}^{t+\Delta
        t}\underline{\sigma}^{dev}\right]\right\}
  +\underline{\sigma}^{refdev}\,,
\end{equation}
which may be rewritten:
\begin{equation}
^{t+\Delta t}\underline{\sigma}^{dev}\left(a_{E}+\alpha\Delta
  t\phantom{}^{\tau}\gamma\right)={}^{t+\Delta
  t}\underline{\epsilon}^{\prime\;dev}-\Delta
t\phantom{}^{\tau}\gamma\left(1-\alpha\right)^{t}\underline{\sigma}^{dev}+a_{E}\underline{\sigma}^{refdev}\,.
\end{equation}
...
\begin{gather}
  ...
  b=\frac{1}{2}{}^{t+\Delta
    t}\underline{\epsilon}^{\prime\;dev}\cdot{}^{t+\Delta
    t}\underline{\epsilon}^{\prime\;dev}+a_{E}{}^{t+\Delta
    t}\underline{\epsilon}^{\prime\;dev}\cdot\underline{\sigma}^{refdev}+a_{E}^{2}J_{2}^{refdev}\,.\\
  c=\Delta t\left(1-\alpha\right){}^{t+\Delta
    t}\underline{\epsilon}^{\prime\;dev}\cdot^{t}\underline{\sigma}^{dev}+\Delta
  t\left(1-\alpha\right)a_{E}\,^{t}\underline{\sigma}^{dev}\cdot\underline{\sigma}^{refdev}\,\,\nonumber \\
